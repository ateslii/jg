      ...
      {({ isValid }) => (
        <FormWrapper autoComplete="off" className="waiver">
          <FieldSet>
            ...
            <FlexContainer>
              <InputContainer>
                <InputLabel htmlFor="name">Полное имя</InputLabel>
                <Input
                  name="name"
                  type="text"
              ...
              <InputContainer>
                <InputLabel htmlFor="user-birthday">Дата рождения</InputLabel>
            ...
            <FlexContainer>
              ...
              <InputContainer>
                ...
                <Input
                  ...
                  title="Электронное письмо должно содержать символ «@» перед доменом"
                />
