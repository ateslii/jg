  ...
  return (
    <>
      ...
      <Section>
        ...
        {/*  ))}*/}
        {/*</Swiper>*/}
        <Title mobile={'mobile'}>Свежие татуировки</Title>
        <Swiper>
          {freshArray.map((item, index) => (
            <swiper-slide class="slide" lazy="true" key={index}>
              <Image style={{ height: '375px', objectFit: 'cover' }} src={item} loading="lazy" alt={`fresh-${index}`} />
            </swiper-slide>
          ))}
        </Swiper>
        <Title mobile={'mobile'}>Зажившие татуировки</Title>
        <Swiper>
